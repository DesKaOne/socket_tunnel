...
class AuthenticationHelper {
  ...
  BigInt calculateS(BigInt xValue, BigInt serverBValue) {
    ...
    final result = modPow(intValue2, _smallAValue! + (_uValue! * xValue), N);
    return result % N!;
  }
  ...
  String toUnsignedHex(String input) {
    ...
    if (negative) {
      ...
      final updatedLeadingDigit = (int.parse(toReplace) | 0x8).toRadixString(
        16,
      );
